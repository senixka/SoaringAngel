...
public class Ice extends Bullet {
    public static final Texture IMG1 = new Texture(Gdx.files.internal("Ice1.psd"));
    public static final Texture IMG2 = new Texture(Gdx.files.internal("Ice2.psd"));
    public static final Random rnd = new Random();

    public Ice(Vector3 vect, float x, float y) {
